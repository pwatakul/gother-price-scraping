    ...
    <Table>
      <TableHeader>
        <TableRow>
          ...
          <TableHead className="text-right">Last Price (THB)</TableHead>
          ...
          <TableRow key={hotel.id}>
            ...
            <TableCell className="text-right">
              {hotel.last_price_thb ? (
                <span className="font-semibold">{formatPrice(hotel.last_price_thb)}</span>
              ) : (
            ...
            <TableCell>
              {hotel.last_price_source ? (
                <Badge variant="info">{hotel.last_price_source}</Badge>
              ) : (
                <span className="text-muted-foreground">—</span>
              )}
            </TableCell>
