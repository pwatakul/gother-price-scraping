...
| 9 | **Final submission package** — repo clean-up, tag the release commit, confirm submission format per competition rules | High | Todo — not started; do last, once judge dry-run in the browser (Task 3 remainder) is done |
